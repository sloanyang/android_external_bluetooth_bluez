				...
				gboolean powered, void *data)
{
	...
	int err;
#ifdef BT_ALT_STACK
    info("%s : powered: %d ",__FUNCTION__,powered);
#endif
						...
						uint8_t *data)
{
	...
	//Reference core 4.0 spec page 1761 table 18.1 Flags. if the flags >2 ,the device support EDR
	if (eir_data.flags < 0 || eir_data.flags > 2) {
		le = FALSE;
